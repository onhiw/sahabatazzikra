package com.ronirusmayadi.sahabatqu.Notification;
...
public class OreoNotification extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.ronirusmayadi.sahabatqu";
    private static final String CHANNEL_NAME = "sahabatqu";
    ...
    public  Notification.Builder getOreoNotification(
        ...
        return new Notification.Builder(getApplicationContext(), CHANNEL_ID)
                ...
                .setBadgeIconType(R.drawable.ic_access_time)
