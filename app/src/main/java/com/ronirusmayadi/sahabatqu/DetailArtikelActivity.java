...
public class DetailArtikelActivity extends AppCompatActivity {
    ...
    private void loadData(){
        ...
        final String mLink = intent.getStringExtra(ArtikelAdapter.KEY_LINK);
        final String mTitle = intent.getStringExtra(ArtikelAdapter.KEY_TITLE);
        setTitle(mTitle);
        webView.getSettings().setJavaScriptEnabled(true);
        webView.setWebViewClient(new DetailArtikelActivity.MyBrowser());
